const { protocol, host } = window.location,
      ...
      repository = "cmdruid.github.io", // Name of the repository.
...
if (devmode) console.debug('Dev mode enabled.');
renderCards();
...
async function fetchBranchIndex(sha) {
  ...
  return log(data.tree.filter(t => t.type === "tree").map(t => t.path));
}
